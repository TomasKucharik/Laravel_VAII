...
@section('content')
    ...
    <div class="col-12 text-center mt-5">
        <h1 class="text-dark pt-4">Pokemon</h1>
        <div class="border-top border-primary w-25 mx-auto my-3"></div>
        <p class="lead">Pribeh pokemon</p>
...
{{--                <h1 class="text-dark font-weight-bold mb-3">Some text</h1>--}}
{{--                <p class="mb-4">Some sub text</p>--}}
{{--                <a href="#" class="btn btn-outline-dark btn-lg">Čítaj viac</a>--}}
{{--            </div>--}}
{{--            <div class="col-lg-8"><img src="https://images4.alphacoders.com/851/thumb-1920-851082.jpg" class="img-fluid" width="300px" height="150px"></div>--}}
{{--        </div>--}}
{{--    </div>--}}
